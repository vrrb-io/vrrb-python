...
from config.blockchain_config import VRRB_ALPHABET

__version__ = '2.1.0'

# 58 character alphabet used
VRRB_ALPHABET = VRRB_ALPHABET
VRRB_ALPHABET = VRRB_ALPHABET

# Retro compatibility
alphabet = VRRB_ALPHABET
...
def b58encode_int(
    i: int, default_one: bool = True, alphabet: bytes = VRRB_ALPHABET
) -> bytes:
    """
...
def b58encode(
    v: Union[str, bytes], alphabet: bytes = VRRB_ALPHABET
) -> bytes:
    """
